#include "shell.h"
/**
 * add_node - Adds up a node to the beginning of the list
...
/**
 * add_node_end - Adds up a node to ending of the list
 * @head: Address of the pointer to head node
 * @str: str field of node
 * @num: Node index utilized by history
 *
...
/**
 * print_list_str - Outputs only the str element of a list_t linked list
...
/**
 * delete_node_at_index - Takes out node at given index
