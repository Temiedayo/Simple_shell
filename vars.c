#include "shell.h"
/**
 * is_chain - Checks if present char in buffer is a chain delimeter
...
/**
 * check_chain - Scans if chaining should continue based on last status
 * @info: Parameter struct
 * @buf: Char buffer
 ...
 * @info: Parameter struct.
 *
 * Return: 1 if its replaced, 0 if not.
 */
